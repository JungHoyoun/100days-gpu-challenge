...
| day8 | **rmsnorm.cu**: Applied the segment_sum technique on implementing RMSnorm (1)    |
| day9(TODO) | **rmsnorm.cu**: Applied the segment_sum technique on implementing RMSnorm (2)    |
